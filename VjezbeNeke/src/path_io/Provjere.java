...
public class Provjere {
	...
	public static void main(String[] args) throws IOException {
		Path pjesma = Paths
				.get("C:/Users/Tomislav/workspace/VjezbeNeke/Fajlovi/Copy of pjesma.txt");
		File text = new File(pjesma.toUri());
		Path folder = Paths.get("C:/A");
		Path folder2 = Paths
				.get("C:/Users/Tomislav/workspace/VjezbeNeke/Fajlovi/");
		System.out.println(text.exists());
		System.out.println(Files.isReadable(pjesma));
		System.out.println(Files.isWritable(pjesma));
		System.out.println(Files.isExecutable(pjesma));

		try {
			Files.copy(folder, folder2, REPLACE_EXISTING);
		...
		try {
			Files.delete(pjesma);
			System.out.println(pjesma.getFileName() + " izbrisana");
		} catch (IOException e) {
			System.err.println("No such file anymore");
		}
